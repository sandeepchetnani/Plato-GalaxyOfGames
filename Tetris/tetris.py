...
img1 = pygame.image.load('assss/1.png')
img2 = pygame.image.load('assss/2.png')
img3 = pygame.image.load('assss/3.png')
img4 = pygame.image.load('assss/4.png')
...
font = pygame.font.Font('fonss/Alternity-8w7J.ttf', 50)
