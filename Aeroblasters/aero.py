...
import random
import pygame
from obsss import Background, Player, Enemy, Bullet, Explosion, Fuel, \
...
plane_img = pygame.image.load('asses/plane.png')
logo_img = pygame.image.load('asses/logo.png')
fighter_img = pygame.image.load('asses/fighter.png')
clouds_img = pygame.image.load('asses/clouds.png')
clouds_img = pygame.transform.scale(clouds_img, (WIDTH, 350))

home_img = pygame.image.load('asses/Buttons/homeBtn.png')
replay_img = pygame.image.load('asses/Buttons/replay.png')
sound_off_img = pygame.image.load("asses/Buttons/soundOffBtn.png")
sound_on_img = pygame.image.load("asses/Buttons/soundOnBtn.png")
...
game_over_font = 'fon/ghostclan.ttf'
tap_to_play_font = 'fon/BubblegumSans-Regular.ttf'
score_font = 'fon/DalelandsUncialBold-82zA.ttf'
final_score_font = 'fon/DroneflyRegular-K78LA.ttf'
...
player_bullet_fx = pygame.mixer.Sound('soun/gunshot.wav')
click_fx = pygame.mixer.Sound('soun/click.mp3')
collision_fx = pygame.mixer.Sound('soun/mini_exp.mp3')
blast_fx = pygame.mixer.Sound('soun/blast.wav')
fuel_fx = pygame.mixer.Sound('soun/fuel.wav')

pygame.mixer.music.load('soun/Defrini - Spookie.mp3')
