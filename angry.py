...
from obs import Player, Bar, Ball, Block, ScoreCard, Message, Particle, generate_particles
...
pygame.font.init()
score_font = pygame.font.Font('fonss/BubblegumSans-Regular.ttf', 50)

# souns

coin_fx = pygame.mixer.Sound('souns/coin.mp3')
death_fx = pygame.mixer.Sound('souns/death.mp3')
move_fx = pygame.mixer.Sound('souns/move.mp3')
...
for i in range(1,5):
	if i == 2:
		...
		ext = "jpg"
	img = pygame.image.load(f"assss/Backgrounds/bg{i}.{ext}")
	img = pygame.transform.scale(img, (WIDTH, HEIGHT))
	bg_list.append(img)

home_bg = pygame.image.load(f"assss/Backgrounds/home.jpeg")
...
while running:
	...
	if home_page:
		...
		if bird_dead and len(destruct_group) == 0:
			score_page = True
			font =  "fonss/BubblegumSans-Regular.ttf"
			if score < high_score:
