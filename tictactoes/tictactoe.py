...
play_area = tk.Frame(root, width=1000, height=1000, bg='white')
XO_points = []
X_points = []
O_points = []
class XOPoint:
    def __init__(self, x, y):
        ...
        self.y = y
        self.value = None
        self.button = tk.Button(play_area, text="", width=30, height=10, command=self.set)
    ...
    def reset(self):
        self.button.configure(text="", bg='black')
        if self.value == "X":
