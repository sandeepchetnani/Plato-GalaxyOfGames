...
from oobb import Ground, Dino, Cactus, Cloud, Ptera, Star
...
start_img = pygame.image.load('as/start_img.png')
start_img = pygame.transform.scale(start_img, (60, 64))

game_over_img = pygame.image.load('as/game_over.png')
game_over_img = pygame.transform.scale(game_over_img, (200, 36))

replay_img = pygame.image.load('as/replay.png')
replay_img = pygame.transform.scale(replay_img, (40, 36))
replay_rect = replay_img.get_rect()
replay_rect.x = WIDTH // 2 - 20
replay_rect.y = 100

numbers_img = pygame.image.load('as/numbers.png')
numbers_img = pygame.transform.scale(numbers_img, (120, 12))

# sc *********************************************************************

jump_fx = pygame.mixer.Sound('sc/jump.wav')
die_fx = pygame.mixer.Sound('sc/die.wav')
checkpoint_fx = pygame.mixer.Sound('sc/checkPoint.wav')
