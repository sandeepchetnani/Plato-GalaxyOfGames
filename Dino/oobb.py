...
class Ground():
	def __init__(self):
		self.image = pygame.image.load('as/ground.png')
...
class Dino():
	def __init__(self, x, y):
		...
		for i in range(1, 4):
			img = pygame.image.load(f'as/Dino/{i}.png')
		...
		self.dead_image = pygame.image.load(f'as/Dino/8.png')
...
class Cactus(pygame.sprite.Sprite):
	def __init__(self, type):
		...
		for i in range(5):
			scale = 0.65
			img = pygame.image.load(f'as/Cactus/{i+1}.png')
			w, h = img.get_size()
...
class Ptera(pygame.sprite.Sprite):
	def __init__(self, x, y):
		...
		for i in range(2):
			scale = 0.65
			img = pygame.image.load(f'as/Ptera/{i+1}.png')
			w, h = img.get_size()
			img = pygame.transform.scale(img, (int(w*scale), int(h*scale)))
			self.image_list.append(img)
...
class Cloud(pygame.sprite.Sprite):
	def __init__(self, x, y):
		...
		self.image = pygame.image.load(f'as/cloud.png')
...
class Star(pygame.sprite.Sprite):
	def __init__(self, x, y, type):
		...
		image = pygame.image.load(f'as/stars.png')
		self.image_list = []
		for i in range(3):
