...
from osssss import Player, Bar, Ball, Block, ScoreCard, Message, Particle, generate_particles
...
pygame.font.init()
score_font = pygame.font.Font('fsssss/BubblegumSans-Regular.ttf', 50)

# snnnnn

coin_fx = pygame.mixer.Sound('snnnnn/coin.mp3')
death_fx = pygame.mixer.Sound('snnnnn/death.mp3')
move_fx = pygame.mixer.Sound('snnnnn/move.mp3')
...
for i in range(1,5):
	if i == 2:
		...
		ext = "jpg"
	img = pygame.image.load(f"asssss/Backgrounds/bg{i}.{ext}")
	img = pygame.transform.scale(img, (WIDTH, HEIGHT))
	bg_list.append(img)

home_bg = pygame.image.load(f"asssss/Backgrounds/home.jpeg")
...
while running:
	...
	if home_page:
		...
		if bird_dead and len(destruct_group) == 0:
			score_page = True
			font =  "fsssss/BubblegumSans-Regular.ttf"
			if score < high_score:
